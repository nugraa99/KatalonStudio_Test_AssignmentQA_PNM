...
//  ASSERTION
	TestObject namakedua = findTestObject('Object Repository/locator_practiceform/input_Name_lastName')
	String akhirnama = WebUI.getAttribute(namakedua, 'value')
	
	if (!akhirnama) {
		WebUI.focus(namakedua)
