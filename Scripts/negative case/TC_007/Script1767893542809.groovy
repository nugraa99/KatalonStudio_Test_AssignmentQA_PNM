...
//	action step
	...
	//  ASSERTION
	TestObject nomorhape = findTestObject('Object Repository/locator_practiceform/input_(10 Digits)_userNumber')
	String phonenumber = WebUI.getAttribute(nomorhape, 'value')
	
	// regular expression 10 digit angka
	String phonepattern = /^\d{10}$/ 
	
	if (!(phonenumber ==~ phonepattern)) {
		println("Nomor HP harus 10 angka")
		WebUI.focus(nomorhape)        
	} else {
		println("Nomor HP valid, lanjut submit")
	}
