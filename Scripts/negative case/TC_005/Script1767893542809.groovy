...
import com.kms.katalon.core.webui.keyword.builtin.GetAttributeKeyword
...
//	action step
	...
	//  ASSERTION
	TestObject laki = findTestObject('Object Repository/locator_practiceform/label_Male')
	TestObject perempuan = findTestObject('Object Repository/locator_practiceform/label_Female')
	TestObject lainnya = findTestObject('Object Repository/locator_practiceform/label_Other')
	
	String cowo = WebUI.getAttribute(laki, 'checked')
	String cewe = WebUI.getAttribute(perempuan, 'checked')
	String danlainnya = WebUI.getAttribute(lainnya, 'checked')
	
	
	if (!cowo && !cewe && !danlainnya) {
		WebUI.focus(laki)
		WebUI.focus(perempuan)
		WebUI.focus(lainnya)
		println("Harap isi gender")
	} else {
